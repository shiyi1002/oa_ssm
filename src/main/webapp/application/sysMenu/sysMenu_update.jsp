...
<body>
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-menu-dietor">
        <input type="hidden" value="${sysMenu.menuId}" name="menuId">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                ...
                <input type="text" class="input-text"  <c:forEach items="${list}" var="menu">
                    <C:if test="${menu.menuId==sysMenu.menuParentId}">value="${menu.menuName}"</C:if>
                       </c:forEach> placeholder="" id="menuParentName"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" class="input-text" value="${sysMenu.menuPath}" placeholder="" id="menuPath" name="menuPath"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5"> <span class="select-box" style="width:150px;">
				<select class="select" name="menuType" size="1" id="menuType">
  				<option value="1" <c:if test="${sysMenu.menuType==1}">selected="selected"</c:if>>父级菜单</option>
					<option value="2" <c:if test="${sysMenu.menuType==2}">selected="selected"</c:if>>普通菜单</option>
				</select>
				</span></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-5"> <span class="select-box" style="width:150px;">
				<select class="select" name="isPublish" size="1" id="isPublish">
					<option value="1" <c:if test="${sysMenu.isPublish==true}">selected="selected"</c:if>>是</option>
					<option value="0" <c:if test="${sysMenu.isPublish==false}">selected="selected"</c:if>>否</option>
				</select>
				</span></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <textarea name="menuDesc" cols="" rows="" id="menuDesc" class="textarea" placeholder="说点什么...100个字符以内"
                          dragonfly="true" onKeyUp="textarealength(this,100)">${sysMenu.menuDesc}</textarea>
            ...
            callback: function (form) {
                ...
                * */
                $.ajax({
                    url: "sysMenu/update",
                    type: "POST",
                    data: $("#form-menu-dietor").serialize(),
