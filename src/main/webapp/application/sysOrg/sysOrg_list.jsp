...
<div class="pd-20">
    ...
    <div class="cl pd-5 bg-1 bk-gray"> <span class="l">
        ...
        <a class="btn btn-primary radius" href="javascript:;" onclick="admin_org_add('添加组织','sysOrg/toAdd','800')"><i
                class="Hui-iconfont">&#xe600;</i> 添加组织</a> </span> <span class="r">共有数据：<strong>54</strong> 条</span>
    </div>
...
<script type="text/javascript">
    ...
    function batchDel() {
        ...
        layer.confirm('组织删除须谨慎，确认要删除吗？', function (index) {
            var checkes = $(".delBox:checked");//获得多选框对象
            if (checkes.length == 0) {
            ...
            $.ajax({
                url: "sysOrg/batchDel",
                type: "POST",
                data: "idList=" + ids,//把多选框获得的id数组传到后台
                success: function (data) {
                    //根据返回标识给出相应的提示
                    if (data.result) {
                    ...
                    } else {//如果组织下有子节点就不能删除,所以在后台做判断才到前台
